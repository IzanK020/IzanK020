...
double p0=(U2-U1)/(R2-R1);
double p1,p00=p0,p11; 
u1=U1;u2=U1;r=R1;
r1=r;r2=r;
double h=0.1e-2;

//Creamos un flujo de salida para guardar los datos de posicion y tiempo.
ofstream fsalida1("data1.dat", ios::out);
fsalida1<<"%Radio(m))"<<setw(30)<<"Potencial (V)"<<setw(30)<<"Derrivada potencial (V)"<<endl;
fsalida1<<R1<<setw(30)<<U1<<setw(30)<<p00<<endl;
//Resolvemos RK para p0
do{RK4(u1,p00,r1,h);fsalida1<<r1<<setw(30)<<u1<<setw(30)<<p00<<endl;}while (r1<R2);
//Calcuamos p1
...
//Creamos un flujo de salida para guardar los datos de posicion y tiempo.
ofstream fsalida2("data2.dat", ios::out);
fsalida2<<"%Radio(m))"<<setw(30)<<"Potencial (V)"<<setw(30)<<"Derrivada potencial (V)"<<endl;
fsalida2<<R1<<setw(30)<<U1<<setw(30)<<p11<<endl;
do{RK4(u2,p11,r2,h);fsalida2<<r2<<setw(30)<<u2<<setw(30)<<p11<<endl;}while (r2<R2);

cout<<"Valor de p0 "<<p0<<". Valor de p1 "<<p1<<endl;
